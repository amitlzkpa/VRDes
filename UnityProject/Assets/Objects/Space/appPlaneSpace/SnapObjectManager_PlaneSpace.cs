...
public class SnapObjectManager_PlaneSpace : SnapObjectManager
{


    private GameObject parentCloneObj;
    private RefObjects_PlaneSpace refObj;
    ...
    void Start()
    {
        ...
        refObj = parentCloneObj.transform.FindChild("_RefObjects").gameObject.GetComponent<RefObjects_PlaneSpace>();
        updateSnapObjects();
    }
}
