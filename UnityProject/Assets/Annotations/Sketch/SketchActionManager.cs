...
public class SketchActionManager : MonoBehaviour, ActionManager
{
    ...
    public void nextLineColor()
    {
        ...
        sketchMenuManager.setUIColor(lineMaterialArray[currentMaterialIndex].color);
    }
    ...
    {
        sketchMenuManager = sketchMenuObject.GetComponent<SketchMenuManager>();
